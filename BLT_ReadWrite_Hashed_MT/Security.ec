...
clone import Case4.A1_A2_Theory as A1A2 with op timeX <- timeX,       
                                                           op hash_setX      <- hash_setX,   
                                                           op time_setX      <- time_setX,   
                                                           op message_setX   <- message_setX,
                                                           op messageX       <- messageX,    
...
declare module A <: BLT_Adv{-Tag_Wrap_1, -BLT_Wrap, -TsU, -BLTGame, -BLT_Dummy_Time, -Tag_Wrap, -TsU_1, -TsU_2,  -Tag_Wrap_2, -SH_Oracle, -SHGame, -SHGame1, -SHGame2, -SHGame3, -RO, -Case3_Adv3, -BLTGameD, -BLT_Dummy_Repo, -SHGameSimple, -BLTGame', -Case4_Adv1, -Case4_Adv2, -SHGameSimple1, -H_AdvCR}.
declare module A2 <: BLT_Adv_Set{-Tag_Wrap_1, -BLT_Wrap, -TsU, -A, -BLTGame, -BLT_Dummy_Time, -Tag_Wrap, -TsU_1, -TsU_2, -Tag_Wrap_2,  -SH_Oracle, -SHGame, -SHGame1, -SHGame2, -SHGame3, -RO, -Case3_Adv3, -BLTGameD, -BLT_Dummy_Repo, -SHGameSimple, -BLTGame', -Case4_Adv1, -Case4_Adv2, -SHGameSimple1, -H_AdvCR}.
...
cut : Pr [ BLTGameD(TsU_Set(A2), Tag_Wrap, A).main(pkk, skk) @ &m :  
     toTime BLT_Wrap.qt = timeX  pkk RO.t 
  /\ (ogetf TsU.r.[toTime BLT_Wrap.qt]) = hash_setX pkk RO.t
  /\ BLT_Wrap.used = boolX pkk RO.t
  /\ fset1 (toTime BLT_Wrap.qt) = time_setX pkk RO.t
...
local lemma pr7 &m (A <: BLT_Adv{-BLT_Wrap, -TsU}) (A2 <: BLT_Adv_Set{-BLT_Wrap, -TsU}) : 
  ...
  +  Pr[ BLTGame(RO, Tag_Wrap, TsU_Set(A2), BLT_Wrap, A).main() @ &m : ((res /\ BLT_Wrap.used) /\ (tag Tag_Wrap.sk (toTime BLTGame.tg) = BLTGame.tg)) /\ toTime BLTGame.tg = toTime BLT_Wrap.qt /\ HM.H (oget BLT_Wrap.qs) <> (HM.H BLTGame.m) ]. 
rewrite Pr[mu_split (HM.H (oget BLT_Wrap.qs) = (HM.H BLTGame.m))].  timeout 20. smt. qed.
...
apply (case3 A A2 (* A_ll A2_ll   computableAdvs *) &m). move => case3_pr.
...
apply (case4  A A2 (* A_ll A2_ll computableAdvs *) &m). move => case4_pr.
